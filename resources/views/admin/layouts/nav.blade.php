    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
                <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-white" href="{{route('admin.dashboard')}}">{{__('messages.dashboard')}}</a></li>
                @foreach ($breadcrumbs ?? [] as $breadcrumb)
                    @if (!$loop->last && $breadcrumb['url'])
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">
                            <a class="text-white active" href="{{ $breadcrumb['url'] }}">{{ $breadcrumb['name'] }}</a>
                        </li>
                        @else
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">
                            {{ $breadcrumb['name'] }}
