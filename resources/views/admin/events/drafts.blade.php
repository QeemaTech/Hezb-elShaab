                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h6>{{ __('messages.draft_events') }}</h6>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">{{ __('messages.Title') }}</th>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">{{ __('messages.Created_By') }}</th>
                                        <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">{{ __('messages.privacy_status') }}</th>
                                ...
                                <tbody>
                                    @forelse ($events as $index => $event)
                                        <tr data-id="{{ $event->id }}">
                                            ...
                                            <td class="text-center align-middle">
                                                <a href="{{ route('admin.events.show', $event->slug) }}" class="mx-2 text-info font-weight-bold">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="{{ route('admin.events.edit', $event->slug) }}" class="mx-2 text-primary font-weight-bold">
                                                    <i class="fa fa-pen"></i>
                                                </a>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center text-muted py-4">{{ __('messages.no_draft_events_found') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
