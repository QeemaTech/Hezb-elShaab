                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('messages.news')}}</p>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('messages.events')}}</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            {{$events_count}}
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('messages.admins')}}</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            {{$admins_count}}
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">{{__('messages.users')}}</p>
                                        <h5 class="font-weight-bolder mb-0">
                                           {{$users_count}}
                                        </h5>
                                    </div>
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        <img alt="Image placeholder"
                                                            src="{{ asset('dashboard') }}/img/team-3.jpg">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Jessica Doe">
                                                        <img alt="Image placeholder"
                                                            src="{{ asset('dashboard') }}/img/team-4.jpg">
                                                    </a>
                                                </div>
                                            </td>
