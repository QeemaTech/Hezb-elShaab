                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">{{ trans('messages.add_form_title', ['form' => trans('messages.candidates')]) }}</p>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <button class="btn btn-primary btn-sm ms-auto">{{ __('messages.create_candidates') }}</button>
                            </div>
                        </div>
